...
## Function to initiaze all the models and retun the model, param grid and scaling true false
...
# Function to plot accuracy and misclassfication for Train vs Test
...
# Function to evalate multiple models and do plotting
