...
# Function to initialize all the models and return the model, param grid, and scaling true/false
...
# Function to apply scaling based on the Flag
...
# Function to perform Grid search with HyperParameters
def perform_grid_search(model, param_grid, X_train, y_train):
    grid_search = GridSearchCV(estimator=model, param_grid=param_grid, cv=5, scoring='accuracy')
    grid_search.fit(X_train, y_train)
    return grid_search.best_estimator_

# Function to perform Grid search with HyperParameters for Ensemble 
...
# Function to Bind all the metrics
...
# Function to plot confusion Matrix for the given Model
...
# Function to plot accuracy and misclassification for Train vs Test
...
# Function to evaluate multiple models and do plotting
